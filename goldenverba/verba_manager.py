...
class VerbaManager:
    ...
    def import_data(self, fileData: list[FileData], textValues: list[str], logging: list[dict] ) -> list[Document]:
    ...
    def setup_client(self):
        ...
        # Use Weaviate Embedded
            ...
            client = weaviate.Client(
                additional_headers=additional_header,
                embedded_options=EmbeddedOptions( additional_env_vars=additional_env_vars ),
            )
