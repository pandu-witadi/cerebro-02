...
const SettingsComponent: React.FC<SettingsComponentProps> = ({
    ...
    const handleModelChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
        const name = e.target.value;
        setSettingModel(name); // Update the selected template state
    };
    ...
    return (
        <div className="flex justify-between items-start gap-5 mt-3">
            ...
            <div className="flex flex-col lg:justify-center justify-start lg:items-center items-start gap-5 w-full">
                ...
                <div className="flex flex-col w-full bg-bg-alt-verba p-10 rounded-lg shadow-lg gap-2 overflow-y-scroll">
